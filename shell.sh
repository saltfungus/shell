...
do
	...
	then
		sudo dpkg --configure -a && sudo apt-get install -f && sudo apt-get update && sudo apt-get upgrade && sudo apt-get dist-upgrade && sudo apt-get autoclean && sudo apt-get --purge autoremove && git clone https://github.com/saltfungus/shell  && clear
    elif [ "$command" == "ls" ] 
    then
	ls
    elif [ "$command" == "ls -l" ]
